...
Shows open pm-tasks grouped by project and customer.<br>

To see all projects and tasks click here: <a href=$alltasks_url>all tasks</a></nobr>
"
...
set this_url [export_vars -base "/intranet-reporting-translation/FUD_project-trans-tasks-openpmfl" {start_date end_date} ]
...
set header0 {"Date" "ProjectNo" "Cust" "Task Name" "PMCT" "__PMFL__" "Deadl." "SL" "TL" "Type" "__Status__" "Units" "Unit" Trans  Proof Other Description}
set footer0 {
	"&nbsp;"  ""  ""  ""  ""  ""  ""  ""  ""  ""  "" "" "" "" "" "" ""
}
...
<!-- pmfl-auswahl hier nicht noetig ++++++++++++++++++++++++++++++  -->
