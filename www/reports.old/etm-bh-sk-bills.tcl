...
<li>2. Neue Rechnung anlegen
<li>.......2.a Lieferant wurde in Schritt 1 angelegt, erscheint aber noch nicht in der Liste <i>oder</i> erscheint unter anderem Projekt:<br>
<u>Neue Rechnung fuer Projekt SKxxx201x anlegen</u>
<li>.......2.b Lieferant schon unter Projekt gelistet: <u> Neue Rechnung fuer Lieferant XYZ und Projekt SKxxx201x anlegen
</strong><br>	
"
...
select
	...
	c.cost_center_id,
	i.payment_method_id,
	to_char(c.effective_date, 'DD.MM.YYYY') as datum,
	to_char(c.amount, :cur_format) as amount,
	c.currency
...
order by p.project_id,c.provider_id
"
...
set report_def [list \
    group_by project \
    header {
			"#colspan=8 <a href=$project_url$project><strong><font size=2>$project_nr</font></strong></a><br><br><a href=$bill_for_project$project><font color=red> Neue Rechnung fuer Projekt</font>$project_nr<font color=red> anlegen</font></a><br><br>"
	    } \
        content [list \
...
if { "" != $provider_id } {
			set bill_anlegen "<a href=$bill_neu$project_id$provider$provider_id><font color=red>Neue Rechnung fuer Lieferant</font> $provider_name <font color=red> und Projekt </font>$project_nr <font color=red>anlegen</font></a>"
} else {
			set bill_anlegen ""
		}
