...
SELECT 
  ...
  to_char(acs.last_modified, :date_format) as modified_date  


FROM 
  public.im_costs c, 
  public.im_projects p,
  public.acs_objects acs
...
WHERE 
  ...
  AND c.cost_status_id not in ('11000203', '3810','11000197')
  AND  c.amount > 0
  AND  (c.effective_date::date + c.payment_days +10) < current_date
  $where_clause
 ORDER BY (cm) ASC, (customer_name) ASC,coalesce(c.amount,0) DESC, (project_name) ASC
"
