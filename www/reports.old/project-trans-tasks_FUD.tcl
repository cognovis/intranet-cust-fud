...
set menu_label "project-trans-tasks_FUD"
...
set header0 {"Date" "ProjectNo" "Cust" "Task Name" "PM" PMFL "Deadl." "SL" "TL" "Type" "Status" "Units" "Unit" Trans  Proof Other Description}
set footer0 {
	"&nbsp;"  ""  ""  ""  ""  ""  ""  ""  ""  ""  "" "" "" "" "" "" ""
}
...
<!-- HIER WEITERMACHEN MIT PMFL SELECT -->
		<tr>
		  <td class=form-label>no PMFL</td>
		  <td class=form-widget>
		     [im_user_select -include_empty_p 1  edit_id $edit_id]
		  </td>
		</tr>
