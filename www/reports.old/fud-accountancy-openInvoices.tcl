# /intranet-reporting-finance/fud-openInvoice.tcl
#
...
set menu_label "fud-accountancy-openInvoices"
...
set page_title "Payment-openInvoice"
...
set this_url [export_vars -base "/intranet-reporting-finance/fud-openInvoice" {start_date end_date} ]
...
WHERE 
  ...
  AND (p.project_nr LIKE ('9%') OR p.project_nr LIKE ('Z%'))
