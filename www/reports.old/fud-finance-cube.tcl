...
set this_url [export_vars -base "/intranet-reporting-finance/finance-cube" {start_date end_date} ]
...
if {"" != $project_manager_id && 0 != $project_manager_id} {
    lappend criteria "p.project_manager_id = :project_manager_id"
}
...
order by
	...
	coalesce(c.amount_converted,0) DESC,
	customer_name limit 10
"
