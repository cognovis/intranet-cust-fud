...
if { $show_bills } {
		set 	where_bill "and ((TRIM(LEADING 'P' FROM cp.cost_name) = cb.bvgl) OR cb.cost_name is NULL)"	
		} else {
		set where_bill "and cb.cost_name is NULL"				
			}
...
select 
	...
	cb.b_amount,
	to_char(cb.b_amount, :currency_format) as b_amount,
	cb.b_cur,
	cb.b_status,
	i.invoice_office_id
from
...
where   prov.company_id = c.provider_id
	and c.invoice_office_id = o.office_id
	--and o.company_id = prov.company_id
...
set report_def [list \
	...
	"<b><a href=$company_url$provider_id>$company_name</a></b> <br><br> $bank<br><br>$address_block" 
	...
	<tr valign=top>
	  <td width='30%'>
		...
		<tr>
		  ...
		  <td><nobr><b><a href=$flbill_sum_url>zur FLRg-Eintragskontrolle</a></b></nobr></td>		
		</tr>
		</table>
		</form>
	  </td>
...
if { "" == $address_line1 } {
			set address_line1 "<a href='$company_edit_url$provider_id'><font color=red><strong>Str fehlt</strong></font></a>"
		} 
if { "" == $address_city } {
			set address_city "<a href='$company_edit_url$provider_id'><font color=red><strong>Stadt fehlt</strong></font></a>"
		} 

if { "" == $address_postal_code } {
			set address_postal_code "<a href='$company_edit_url$provider_id'><font color=red><strong>PLZ fehlt</strong></font></a>"
		} 
if { "" == $address_country_code } {
			set country_name "<a href='$company_edit_url$provider_id'><font color=red><strong>Land fehlt</strong></font></a>"
		} 
...
#bank-daten pruefen
	if { "" != $bank_iban && "" != $bank_swift || "" != $bank &&  "" != $bank_accno && "" != $bank_sort_code || "" != $bank && "" != $payment_email } {
			set bank "<strong>Bankdaten:</strong> <br> Bankname: $bank <br> IBAN: $bank_iban <br> Swift: $bank_swift <br> Bez. E-Mail: $payment_email <br> Acc-No: $bank_accno <br> Sort Code: $bank_sort_code "
				...
				set bank "<a href='$company_edit_url$provider_id'><font color=red><strong>Bankdaten aktualiseren</strong></font></a>"
		  }
