...
set menu_label "etm-bh_al-fordg-verbindlkt"
...
select
	...
	--10000000 + comp.company_id as kundenoderlieferantenkonto,
	ci.cost_center_id,
...
where
	...
	and ci.creation_date >= to_date(:start_date, 'YYYY.MM.DD')
   	and ci.creation_date <= to_date(:end_date, 'YYYY.MM.DD')
	$agent_where
	$nointernals_where
...
set header0 {"Buchungsbetrag netto" "Buchungsbetrag Steuer" "Buchungsbetrag brutto" "Kunden-bzw. Lieferantenkonto" "Rechnungsnummer" "Rechnungsdatum" "Sachkonto" "Buchungstext" "Eingangsdatum" "Nachtraeglich geaendert?"}
set footer0 {}
