...
select 	row_number() over (order by i.payment_method_id, comp.company_name) as paym_index,
	...
	comp.bank,
	acs.creation_date,
	to_char(acs.creation_date, 'YYYY.MM.DD:hhmm') as creation_date_formatted,
...
set header0 {"Pos" "Empfaengername" "Kontonummer/IBAN" "Bankleitzahl/BIC" "Bill" "Betrag" "Waehrung" "Mandatsreferenz" "Verwendungszweck 1" "Verwendungszweck 2" "Verwendungszweck 3" "Verwendungszweck 4" "Bank" "Bezahl-Mail (PP/MB)" "Bezahlmethode" "RgFL" "Rg-Datum" "angelegt am" "Status" "Cost_ID" "angelegt von" "nachtraeglich geaendert?" }
set footer0 {}
...
#if {"" != $i} { regsub -all {[Ü]}  $i "Ue" i}
#if {"" != $i} { regsub -all {[^a-zA-Z0-9[:space:]]}  $i "" i}
#}
