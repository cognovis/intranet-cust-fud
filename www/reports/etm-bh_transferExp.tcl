...
set header0 {"Pos" "NoteID" "Agentur" "Empfaengername" "Company" "Kontonummer/IBAN" "Bankleitzahl/BIC" "Betrag" "Waehrung" "Mandatsreferenz" "Verwendungszweck 1" "Verwendungszweck 2" "Verwendungszweck 3" "Verwendungszweck 4" "Bank" "Bezahl-Mail (PP/MB)" "Bezahlmethode" "RgFL" "Rg-Datum" "Status" "Cost_ID" "angelegt von" "nachtraeglich geaendert?" }
set footer0 {}
