...
where
   ...
   and ci.effective_date <= to_date(:end_date, 'YYYY.MM.DD')
	$agent_where
	$nointernals_where
	--and comp.company_type_id = '11000327'
order by comp.company_type_id
"
...
set header0 {"Buchungsbetrag netto" "Buchungsbetrag Steuer" "Buchungsbetrag brutto" "Kunden-bzw. Lieferantenkonto" "Rechnungsnummer" "Rechnungsdatum" "Sachkonto" "Buchungstext"}
set footer0 {}
